...
void M5Display::begin() {
  ...
  fillScreen(0);
  #if defined (ARDUINO_M5Stack_Core_ESP32) || defined (ARDUINO_M5STACK_FIRE) || defined (ARDUINO_LOLIN_D32_PRO) || defined (ARDUINO_FROG_ESP32)//TTGO T4 v1.3  //piranha_esp-32 
