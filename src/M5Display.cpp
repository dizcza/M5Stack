...
#if defined (ARDUINO_M5Stick_C) || defined (ARDUINO_M5STACK_Core2) || defined (ARDUINO_TWatch) || defined (ARDUINO_ESP32_DEV_UNUSED) //M35
  #include "drivers/M5x/AXP192/AXP192.h"
#endif
#if defined (ARDUINO_ESP32_DEV_UNUSED) || defined (ARDUINO_D1_MINI32)	//M35, K36
